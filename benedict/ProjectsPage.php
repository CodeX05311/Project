...
<head>
    ...
    <link rel="stylesheet" href="FinalProjectPageDesign.css">
...
<body>
    ...
    <?php 
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $value) {
                echo "<div id='titleandDescription'>";
                echo "<h1>" . htmlspecialchars($value['title']) . "</h1>";
                echo "<p>" . htmlspecialchars($value['description']) . "</p>";
                echo "</div>";
                echo "<div class='finalProject'>";
                echo "<div style=\"background-image: url('" . htmlspecialchars($value['image']) . "');\">";
                echo "</div>";
                echo "</div>";
                if($condition){
                ...
                echo "<form action='editDocumentsPage2.php' method='POST'>";
    ...
    <?php if($condition): ?>
    <form action='editDocumentsPage2.php' method="POST">
