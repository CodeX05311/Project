...
<head>
    ...
    <link rel="stylesheet" href="ActivitiesPageDesign.css">
...
<body>
    ...
    <?php 
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $value) {
                ...
                echo "<form action='editsDocumentsPage.php' method='POST'>";
    ...
    <?php if($condition): ?>
    <form action='editsDocumentsPage.php' method="POST">
    ...
    <div class="footer">
        <div>
            ...
            <p>Gmail: <br> <?php echo trim($temp[0])?> <br> 44@gmail.com</p>
        </div>
        <div>
            <div class="title">
                <h6>Language Used</h6>
